...
export const EditPostDialog=(
    ...
    useEffect(()=>{
        ...
        console.log(currentPostInfo.description);
    },[post]);
    useEffect(()=>{(async ()=>{
                    ...
                    <DialogBody>
                        ...
                        <DialogContent>
                            ...
                            <Combobox 
                                ...
                                selectedOptions={categories.map(item=>(item as any).value).includes(currentPostInfo.category)?[currentPostInfo.category!]:[]}
                                freeform
